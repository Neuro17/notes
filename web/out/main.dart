...
void init_autogenerated() {
  ...
  var __createNewLink, __e0, __e2, __header, __main, __refresh, __todoList, __todoapp;
  ...
  new AddLink.forElement(__e0);
  __t.component(__e0);
  __createNewLink = __header.query('#createNewLink');
  __t.listen(__createNewLink.onClick, ($event) { addTodo($event); });
  __refresh = __header.query('#refresh');
  __main = __todoapp.query('#main');
  __todoList = __main.query('#todo-list');
  __e2 = __todoList.query('#__e-2');
  __t.loop(__e2, () => (app.links), (x, __t) {
    var __e1;
    __e1 = new autogenerated.Element.html('<x-link-row> </x-link-row>');
    __t.oneWayBind(() => (x), (e) { __e1.xtag.link = e; }, false);
    new LinkRow.forElement(__e1);
    __t.component(__e1);
    __t.addAll([
