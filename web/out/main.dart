...
void init_autogenerated() {
  ...
  var __createNewLink, __e1, __header, __main, __refresh, __todoList, __todoapp;
  ...
  __t.listen(__createNewLink.on.click, ($event) { addTodo($event); });
  __refresh = __header.query('#refresh');
  __main = __todoapp.query('#main');
  __todoList = __main.query('#todo-list');
  __e1 = __todoList.query('#__e-1');
  __t.loop(__e1, () => (app.links), (x, __t) {
    var __e0;
    __e0 = new autogenerated.Element.html('<x-link-row> </x-link-row>');
    __t.oneWayBind(() => (x), (e) { __e0.xtag.link = e; }, false);
